...
public class E09InsertionSortBenchmark {
    @State(Scope.Thread)
    ...
    @Benchmark
    public Integer[] insertionSortDescending(DescendingSetup state) {
        Integer[] a = state.obtainCopy();
        E09InsertionSort.insertionSort(a);
        return a;
    }

    @Benchmark
    public Integer[] insertionSortAscending(AscendingSetup state) {
        Integer[] a = state.obtainCopy();
        E09InsertionSort.insertionSort(a);
        return a;
    }
